...
export class PopupComponent extends Component<PopupComponentData> {
  protected _closeBtn: HTMLButtonElement = ensureElement<HTMLButtonElement>(elements.popup.closeBtn, this.container);
  protected _content: HTMLElement = ensureElement<HTMLElement>(elements.popup.content, this.container);
...
export class Form<T> extends Component<IState> {
	...
	constructor(protected container: HTMLFormElement, protected events: IEvents) {
		...
		this._errors = ensureElement<HTMLElement>(elements.popup.content, this.container);
